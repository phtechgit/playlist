...
import com.pheuture.playlists.base.receiver.NotificationActionReceiver;
...
import com.pheuture.playlists.base.constants.NotificationChannelID;
...
public class PendingFileUploadService extends Service implements NotificationChannelID,
    ...
    public void onCreate() {
        ...
        pendingFileUploadLocalDao = LocalRepository.getInstance(this).pendingUploadLocalDao();

        pendingUploadEntities = pendingFileUploadLocalDao.getAllPendingUploadEntities();
    ...
    private void updateTaskStatus() {
        ...
        pendingFileUploadLocalDao.delete(pendingFileUploadEntity);
