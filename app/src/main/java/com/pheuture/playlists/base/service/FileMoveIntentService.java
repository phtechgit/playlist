...
public class FileMoveIntentService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        offlineMediaLocalDao = LocalRepository.getInstance(this).offlineMediaLocalDao();
    }
    ...
    private void handleActionMove(long downloadId, String source) {
        try {
            ...
            offlineMediaLocalDao.updateOfflineVideoStatus(downloadId, destinationFile.getAbsolutePath(), DownloadManager.STATUS_SUCCESSFUL);
