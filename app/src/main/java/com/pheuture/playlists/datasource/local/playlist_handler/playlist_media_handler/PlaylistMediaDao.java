...
public interface PlaylistMediaDao {
    ...
    @Query("select * from PlaylistMediaEntity where playlistID=:playlistID and mediaTitle like:searchQuery LIMIT :limit OFFSET :offset")
    List<PlaylistMediaEntity> getPlaylistMediaEntities(long playlistID, String searchQuery, int limit, int offset);
}
